...
Module.prototype.wrapRequire = function() {
  var self = this;
...
Module._extensions['.json'] = function(module, filename) {
  var content = NativeModule.require('fs').readFileSync(filename, 'utf8'),
      ...
      require = module.wrapRequire(),
      wrapped = '(function (global, module, require, __filename, __dirname) { ' +
        'module.exports = ' + content + ';});',
      compiled = runInThisContext(wrapped, filename, true);

  compiled.apply(module.exports, [global, module, require, filename, dirname]);
};
