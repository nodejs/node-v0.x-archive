...
exports.connect = exports.createConnection = function(port /* [host] || [options], [cb] */) {
  var s;
...
Socket.prototype.connect = function(port /* [host] || [options], [cb] */) {
  var self = this;
  ...
  if (pipe) {
    ...
    require('dns').lookup(host, function(err, ip, addressType) {
      if (err) {
        ...
        connect(self, ip, port, addressType, localAddress);
      }
    });

  } else {
    debug("connect: missing host");
    connect(self, '127.0.0.1', port, 4, localAddress);
  }
};
