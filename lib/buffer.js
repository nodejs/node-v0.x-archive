...
Buffer.prototype.fill = SlowBuffer.prototype.fill = function fill(perIndexCallback) {
  //TODO: Verify that perIndexCallback is a function

  var i, len, indexValue;
  len = this.length;
  for (i = 0; i < len; i++) {
    indexValue = Number(perIndexCallback.call(this, i));
    this[i] = isFinite(indexValue) ? indexValue : 0
  }
  return true;
};
